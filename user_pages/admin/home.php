...
<!-- CONTENT BEGIN -->
        <div id="content">
        	<div class="span-23 float-left">
                <h3 class="title">Administrare</h3>
                <div class="span-container">
                    <div>Pentru a sterge / bloca un utilizator mergeti la pagina "Administrare utilizatori".<br /><br /></div>
                    <div>Pentru a sterge / modifica o cerere de furnizare mergeti la pagina "Cereri de furnizare".<br /><br /></div>
                    <div>Pentru a sterge / modifica o oferta de furnizare mergeti la pagina "Oferte de furnizare".<br /><br /></div>
                    <div>Pentru a administra continutul website-ului mergeti la pagina "Administrare website".</div>
