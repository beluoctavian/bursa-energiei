...
<!-- CONTENT BEGIN -->
        <div id="content">
        	<div class="span-23 float-left">
                ...
                <h3 class="title">Reclame</h3>
                <div class="span-container error">Latimea recomandata a imaginilor este de 243 pixeli.</div><br />
                ...
                <textarea id="editor" name="editor">
					...
					$query->execute();
					$reclame = $query->fetch(PDO::FETCH_ASSOC);
					echo $reclame['content'];
					?>
                </textarea>
