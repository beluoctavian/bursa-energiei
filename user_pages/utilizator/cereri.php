        	...
        	<div class="span-23 span-container">
                ...
                foreach ($cereri as $cerere) {
                    ...
                    <tr>
                        ...
                        <td><a href="../../request.php?id=<?php echo $cerere['id']; ?>"><?php echo $cerere['consum_anual'];?> kWh</a></td>
                        ...
                        <td><a href="../../request.php?id=<?php echo $cerere['id']; ?>"><?php echo $cerere['oferte'];?></a></td>
                    </tr>
                    <?php
                }
                ?>
